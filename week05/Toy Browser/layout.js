...
function layout(element) {
    ...
    var mainSize, mainStart, mainEnd, mainSign, mainBase, crossSize, crossStart, crossEnd, crossSizn, crossBase;
    ...
    for (let i = 0; i < items.length; i++) {
        ...
        if (itemStyle.flex) {
            ...
            if (itemStyle[crossSize] !== null && itemStyle[corssSize] !== (void 0))
            ...
            if (itmStyle[crossSize] !== null && itemStyle[crossSize] !== (void 0)) 
                crossSpace = Math.max(crossSpace, itemStyle[crossSize]);
            mainSpace -= itemStyle[mainSize];
        }
    }
